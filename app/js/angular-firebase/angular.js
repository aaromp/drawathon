 ...
 * 
 * <pre>
 * var drawathon = angular.module('drawathon', []);
 * drawathon.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://drawathon.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://drawathon.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('drawathon', []).config(function($sceDelegateProvider) {
 ...
 *        'http://drawathon.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="drawathonController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("drawathonController", function drawathonController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('drawathonWithSceDisableddrawathon', []).config(function($sceProvider) {
